...
const FirstPage = () => {
  return (
    <View style={styles.container}>
      ...
      <View style={styles.newRectangleBelow}>
        <Text style={styles.newRectangleBelowText}>Activity_name</Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  newRectangleBelow: {
    ...
    paddingLeft: 15, // Add padding to move text further to the left
    marginVertical: 10,
  },
  newRectangleBelowText: {
    fontSize: 12,
    color: '#000000', // Black color for text in newRectangleBelow
  },
  content: {
    flex: 1,
    justifyContent: 'center',
